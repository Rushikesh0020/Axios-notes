...
//Put: meant to replace entire
//Patch: meant to update only
function updateTodo() {
  ////PutRequest
  // axios
  // .put('http://jsonplaceholder.typicode.com/todos/1',{
  //     title: 'Updated Todo by Hrishi',
  //     completed: true
  // })
  //     .then(res => showOutput(res))
  //     .catch(err => console.error(err));
...
function errorHandling() {
  axios
    .get("http://jsonplaceholder.typicode.com/todosssssss", {
...
// CANCEL TOKEN : we can cancel requests on the fly
